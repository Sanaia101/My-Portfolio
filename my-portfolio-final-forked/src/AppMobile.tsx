...
const AppMobile: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-800 flex items-center justify-center p-4 font-sans overflow-y-scroll snap-y snap-mandatory scroll-smooth">
      <div className="w-full max-w-[720px] bg-pink-50 snap-start rounded-[2rem] border-4 border-white ring-4 ring-pink-300 shadow-2xl flex flex-col items-center px-4 pt-6 space-y-4">
